 ...
 */
@Component
public class UnitPersistenceToDomain extends AbstractNamedPersistenceToDomain<local.tin.tests.crud.model.persistence.Unit, local.tin.tests.crud.model.domain.Unit, Integer> {
