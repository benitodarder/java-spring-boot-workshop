 ...
 */
@Component
public class UnitDomainToPersistence extends AbstractNamedDomainToPersistence<local.tin.tests.crud.model.domain.Unit, local.tin.tests.crud.model.persistence.Unit, Integer> {
